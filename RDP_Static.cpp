...
int main(int argc, char *argv[])
{
	...
	#pragma omp parallel for schedule(static,1000000) private(polyline,simplified_polyline,line) shared(AllPolylines,SimplifiedAllPolylines) //to chunk epeireazei ta apotelesmata ws twra >7 bgazei swsta me polla threads
